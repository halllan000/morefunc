...
# A parameter is a variable that exists in the function.
# An argument is a value that you pass into the function.
# The return value is optional (sort of).
# If a function has no return statement, it returns None.
# A local variable is a variable that exists only in the function.
# Scope means where a variable exists.
# A "side effect" is when a function when a function prints or does anything outside the code.

# BONUS: What is the difference between "print" and "return"?
# print: prints something to the terminal (or consol)
# return: returns a value out of a function to where it was called.
